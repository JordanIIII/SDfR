...
int main() {
    ...
    twoDayPackage twoDay("Richi", "Mandarijn Straat", "Vlad", "Lekker Gezellig Straat", 10.0, 5.0, 2.5);
    sameDayPackage sameDay("Jordan", "Calslaan", "Steyn", "Matenweg", 10.0, 5.0, 2.5);
    overnightPackage overnight("Tomoki", "123 Main St", "Sjoerd", "456 Elm St", 10.0, 5.0, 2.5);
    internationalPackage international("Ira", "Teletubbieland", "Malta", "742 Evergreen Terrace", 10.0, 5.0, 2.5);
    ...
    retourPackage retour("Charlie", "123 Oak St", "David", "456 Pine St", 10.0, 5.0, 2.5, 2, 2026001); 
