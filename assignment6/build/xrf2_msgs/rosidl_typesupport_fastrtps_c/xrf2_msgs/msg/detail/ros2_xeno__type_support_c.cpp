...
bool cdr_serialize_xrf2_msgs__msg__Ros2Xeno(
  const xrf2_msgs__msg__Ros2Xeno * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xrf2_msgs
bool cdr_deserialize_xrf2_msgs__msg__Ros2Xeno(
  eprosima::fastcdr::Cdr & cdr,
  xrf2_msgs__msg__Ros2Xeno * ros_message)
{
  // Field name: left_wheel_vel
  {
    cdr >> ros_message->left_wheel_vel;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xrf2_msgs
bool cdr_serialize_key_xrf2_msgs__msg__Ros2Xeno(
  const xrf2_msgs__msg__Ros2Xeno * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: left_wheel_vel
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xrf2_msgs
size_t get_serialized_size_key_xrf2_msgs__msg__Ros2Xeno(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Ros2Xeno__ros_msg_type * ros_message = static_cast<const _Ros2Xeno__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xrf2_msgs
size_t max_serialized_size_key_xrf2_msgs__msg__Ros2Xeno(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const xrf2_msgs__msg__Ros2Xeno * ros_message = static_cast<const xrf2_msgs__msg__Ros2Xeno *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_xrf2_msgs__msg__Ros2Xeno(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  xrf2_msgs__msg__Ros2Xeno * ros_message = static_cast<xrf2_msgs__msg__Ros2Xeno *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_xrf2_msgs__msg__Ros2Xeno(cdr, ros_message);
}
