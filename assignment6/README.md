...
#### IF DESIRED: an exact copy of the two edited packages (red_object_detector, relbot_sequence_controller, and relbot_launch) are inside of the Edited_Packages folder. These were added in case it's simpler to only have these two packages for grading, rather than the entire workspace.
